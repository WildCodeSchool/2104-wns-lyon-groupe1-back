...
export default class FlashcardResolver {
  ...
  public async updateFlashcard(
    ...
    const modifyExistingSubtitle = (givenSubtitle: SubtitleInput): Subtitle => {
      const subtitleToUpdate: Subtitle = this.getSubtitleById(flashcard, givenSubtitle.subtitleId);
