...
const GET_CLASSROOM = gql`{getClassroom(id : "${mockClassroom._id}"){_id, name, year}}`;
//mutation to add a classroom by defining classroomName, 
const ADD_CLASSROOM = gql`mutation{
  addClassroom(classroomName: "dev", academicYear :"2012-2013", studentMails:["eleve1@aca.com", "eleve2@aca.com"])
  {_id, name, year, student{userId, mail}}
}`;
//mutation to add a classroom by providing classroom _id and students email we want to add
const ADD_STUDENT_TO_CLASSROOM = gql`mutation{addStudentToClassroom(id: "${mockClassroom._id}", studentMail : "${mockStudent1.mail}"){_id, student{mail}}
}`;
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
describe(
  ...
  () => {
    ...
    //===========================================================================================
    it(
      "we can create a new classroom by giving academicYear, name, and student mails",
      async () => {
    ...
    it(
      "we can add a student to a classroom by providing classroom id and student mail",
      async () => {
